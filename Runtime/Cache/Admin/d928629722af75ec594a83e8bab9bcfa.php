...
function showMsg(msg){
	$('#data-table').hide();
    $('#showInfomation').html('<div id="listInfo"><div class="content"><h3 class="center"><img src="/weiphp2.0.1202/Public/Admin/images/loading_icon.gif" class="mr10"/>'+msg+'...</h3></div></div>');
}
