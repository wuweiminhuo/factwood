...
<title></title>
<link href="/weiphp2.0.1202/Public/Home/css/mobile_module.css?v=<?php echo SITE_VERSION;?>" rel="stylesheet" type="text/css">
...
<div class="container body">
  ...
  <article>
    ...
    <?php if(!empty($info["end_date"])): ?><p class="time">投票截止日期：<?php echo (time_format($info["end_date"])); ?></p><?php endif; ?>
  </article>
  <p class="vote_type">
